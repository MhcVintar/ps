...
const (
	MessageBoard_CreateUser_FullMethodName          = "/api.MessageBoard/CreateUser"
	MessageBoard_CreateTopic_FullMethodName         = "/api.MessageBoard/CreateTopic"
	MessageBoard_PostMessage_FullMethodName         = "/api.MessageBoard/PostMessage"
	MessageBoard_UpdateMessage_FullMethodName       = "/api.MessageBoard/UpdateMessage"
	MessageBoard_DeleteMessage_FullMethodName       = "/api.MessageBoard/DeleteMessage"
	MessageBoard_LikeMessage_FullMethodName         = "/api.MessageBoard/LikeMessage"
	MessageBoard_GetSubscriptionNode_FullMethodName = "/api.MessageBoard/GetSubscriptionNode"
	MessageBoard_ListTopics_FullMethodName          = "/api.MessageBoard/ListTopics"
	MessageBoard_GetMessages_FullMethodName         = "/api.MessageBoard/GetMessages"
	MessageBoard_SubscribeTopic_FullMethodName      = "/api.MessageBoard/SubscribeTopic"
)
...
func RegisterMessageBoardServer(s grpc.ServiceRegistrar, srv MessageBoardServer) {
	// If the following call pancis, it indicates UnimplementedMessageBoardServer was
...
const (
	ControlPlane_GetClusterState_FullMethodName = "/api.ControlPlane/GetClusterState"
)
