...
func (UnimplementedInternalMessageBoardServiceServer) ApplyWALEntry(context.Context, *ApplyWALEntryRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplyWALEntry not implemented")
}
func (UnimplementedInternalMessageBoardServiceServer) Rewire(context.Context, *RewireRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Rewire not implemented")
}
func (UnimplementedInternalMessageBoardServiceServer) TailHandoff(grpc.BidiStreamingServer[TailHandoffRequest, TailHandoffResponse]) error {
	return status.Error(codes.Unimplemented, "method TailHandoff not implemented")
}
...
func RegisterInternalMessageBoardServiceServer(s grpc.ServiceRegistrar, srv InternalMessageBoardServiceServer) {
	// If the following call panics, it indicates UnimplementedInternalMessageBoardServiceServer was
